  ...
  <div>
    ...
    <select class="form-control" v-model="selectedGenreId">
      ...
      <div class="row mt-5" v-if="selectedGenreId === 0">
        <movie-list-item v-for="movie in movies" :key="movie.id" :genre="genre" :movie="movie"></movie-list-item>
      </div>
      <div class="row mt-5" v-else>
        <movie-list-item v-for="movie in filterMovies" :key="movie.id" :genre="genre" :movie="movie"></movie-list-item>
      </div>
